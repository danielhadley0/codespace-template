...
class KalshiClient:
    ...
    async def authenticate(self):
        ...
        # Skip authentication in paper trading mode (public data access only)
        if settings.paper_trading_mode:
            logger.info("Kalshi client in paper trading mode - skipping authentication (public data only)")
